...
class HomeApiTest : ApiTest() {
    ...
    fun getListRquestTest() = runBlocking {
        ...
        request.path.let {
            assertThat(it).startsWith("/listings/latest?")
            assertThat(it).contains("start=1")
            assertThat(it).contains("limit=15")
    ...
    fun getListSuccessTest() = runBlocking {
        ...
        actual.data?.let { data ->
            ...
            assertThat(data[0].quote.usdQuote.weekVariation).isEqualTo(-6.04970988)
            assertThat(data[0].quote.usdQuote.monthVariation).isEqualTo(-5.45736068)
            ...
            assertThat(data[1].quote.usdQuote.weekVariation).isEqualTo(4.84264827)
            assertThat(data[1].quote.usdQuote.monthVariation).isEqualTo(-13.72832535)
            ...
            assertThat(data[2].quote.usdQuote.weekVariation).isEqualTo(-0.05324913)
            assertThat(data[2].quote.usdQuote.monthVariation).isEqualTo(-0.04819767)
            ...
            assertThat(data[3].quote.usdQuote.weekVariation).isEqualTo(4.35271498)
            assertThat(data[3].quote.usdQuote.monthVariation).isEqualTo(-17.71458232)
            ...
            assertThat(data[4].quote.usdQuote.weekVariation).isEqualTo(2.09695978)
            assertThat(data[4].quote.usdQuote.monthVariation).isEqualTo(-15.55603257)
        }
